...
const HeadshotWithBlob: React.FC<HeadshotWithBlobProps> = ({ className = '', imgPath = '/headshot1.jpg' }) => {
  return (
    <div className={`flex-1 p-6 md:p-12 flex items-center justify-center ${className}`}>
