  ...
  return (
    <article className="relative group">
      ...
      <FadeIn delay={`${index * 300}ms`}>
        <div className="absolute -bottom-2 -right-2 w-full h-full bg-black transition-transform duration-300"></div>

        {/* Main card */}
        <div
          className={`relative ${bgColor} border-2 border-black  bg-gradient-to-br`}
        >
          <div className="grid grid-rows-[auto_1fr_auto] p-8">
            <header className="space-y-4">
              <div
                className={`${color} w-16 h-16 rounded-xl flex items-center justify-center mb-6 border-2 border-black`}
              >
...
const Services: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      <div className="bg-white w-full px-4 py-12 md:py-16 flex-grow border-b border-black">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-8xl mx-auto mb-12">
            <h1 className="text-4xl md:text-7xl font-bold mb-6 p-10 text-black font-sans text-center">
              Coaching Services
            </h1>
          </div>
